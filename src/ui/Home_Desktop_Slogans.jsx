...
function Home_Desktop_Slogans() {
  return (
    <div className="block -mt-10 ">
    <div className="md:flex hidden lg:flex-nowrap flex-wrap items-center gap-[46px] text-right child:flex child:flex-col child:gap-y-2 child:bg-gray_base/20 child:px-4 child:py-4  child:rounded-3xl">
      ...
      <div className="shrink-0 md:hidden lg:flex">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
          viewBox="0 0 41 41"
...
export default Home_Desktop_Slogans