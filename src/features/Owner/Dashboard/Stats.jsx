    ...
    <div className="col-span-9 row-span-2 bg-zinc-200/55 rounded-lg mb-2 shadow-sm">
      <div className="w-full">
        ...
        <div className="grid grid-cols-3 w-full h-full p-4 " >
          <div className="flex gap-x-2 w-full h-full px-6 justify-center flex-col mt-2 font-DanaBold items-center "data-aos="zoom-in" data-aos-delay="400"  data-aos-once="false">
          ...
          <div className="flex gap-x-2 w-full h-full px-6 justify-center flex-col mt-2 font-DanaBold items-center "data-aos="zoom-in" data-aos-delay="600"  data-aos-once="false">
            <div className="flex gap-x-2 w-full h-full px-6 justify-center flex-col mt-2 font-DanaBold items-center ">
          ...
          <div className="flex gap-x-2 w-full h-full px-6 justify-center flex-col mt-2 font-DanaBold items-center "data-aos="zoom-in" data-aos-delay="800"  data-aos-once="false">
            <div className="flex gap-x-2 w-full h-full px-6 justify-center flex-col mt-2 font-DanaBold items-center ">
              <div className="text-lg font-DanaBold">{numOfProposals}</div>
              <div className="flex justify-center  items-center gap-x-2">
                <ImNewspaper  size={28} className="text-zinc-600" />
                مجموع درخواست های دریافتی
              </div>
            </div>
          </div>
        </div>
