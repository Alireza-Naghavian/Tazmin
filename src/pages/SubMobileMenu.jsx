  ...
  return (
    ...
    >
      ...
      <div className="w-full bg-[rgb(248,248,248)] h-12 flex shadow-md">
        <div>
          <BackBtn
            icon={<TiArrowRight className="w-8  h-8 mr-2" />}
            color={"text-blue_base"}
          >
      ...
      <div className="p-4">
        <span className="flex flex-col gap-4 font-DanaBold">
          <Link
            to={target_link_1}
            className={`h-auto w-full min-h-[56px] rounded-lg px-4 flex flex-col justify-center shadow-xl custom-right-border ${base_color}  `}
          >
          ...
          <Link
            to={target_link_2}
            className="w-full py-2 px-4 rounded-lg flex gap-4 items-center"
          >
