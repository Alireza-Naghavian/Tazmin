...
function SubMobileMenu({role,main_action,base_color,second_item,last_item}) {
  return (
      <div
      ...
      <div className="p-4">
        <span className="flex flex-col gap-4 font-DanaBold">
          <Link className={`h-auto w-full min-h-[56px] rounded-lg px-4 flex flex-col justify-center shadow-xl custom-right-border ${base_color}  `}>
            <span className="text-sm leading-7 font-DanaBold z-20 text-black_base m-0">
         {main_action}
            </span>
          </Link>
          <Link className="w-full py-2 px-4 rounded-lg flex gap-4 items-center">
